...
fetchDataFromServer(`https://api.themoviedb.org/3/movie/${movieId}?api_key=${api_key}&append_to_response=casts,videos,images,releases`, function
(movie) {
    ...
    url('${imageBaseURL}${"w1280" || "original"}$
    ...
    <div class="detail-box">
        <div class="detail-content">
            ...
            <div class="meta-list">
                ...
                <div class="meta-item">
                    <img src="./assets/images/star.png" alt="20"
                    height="20" alt="raiting">
        ...
        <div class="title-wrapper">
            <h3 class="title-large">Fragmanlar</h3>
        </div>
...
const addSuggestedMovies = function ({ results: movieList }, title) {
        ...
        movieListElem.ariaLabel = `Sana Özel Öneriler`;
    
        movieListElem.innerHTML = `
        <div class="title-wrapper">
            <h3 class="title-large">Sana Özel Öneriler</h3>
        </div>
