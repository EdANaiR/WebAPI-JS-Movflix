...
/**
 * tüm bileşenleri ve işlevleri içe aktar
 */
...
const homePageSections = [
   ...
   {
    title: "En Fazla Oy Alan Filmler",
...
const heroBanner = function ({ results: movieList }) {
   ...
   for (const [index, movie] of movieList.entries()) {
    ...
    class="img-cover" loading=${index === 0 ?
    "eager": "lazy"
      }>
   ...
   <div class="banner-content">
    ...
    onclick="getMovieDetail(${id})">
        ...
        <span class="span">Şimdi İzle</span>
    </a>
   </div>
    `;
    ...
    <img src="${imageBaseURL}w154${poster_path}" alt="Slide
    to ${title}" loading="lazy"
    ...
    <div class="slider-list">
        <div class="slider-inner">
            ...
            <div class="movie-card">
                <a href="./detail.html" class="card-btn" title="Puss in
                 Booys: The Last Wish"></a>
